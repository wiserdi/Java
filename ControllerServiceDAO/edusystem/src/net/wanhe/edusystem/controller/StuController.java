package edusystem.src.net.wanhe.edusystem.controller;

import edusystem.src.net.wanhe.edusystem.service.StuService;
...
public class StuController {
    ...
    public void addStu(){
        ...
        //将获取到的用户数据封装成学生对象
        Student stu = new Student(name,age,phone,address);
        //将数据交给service，由service继续完成

        stuService.addStu(num,stu);
    }
