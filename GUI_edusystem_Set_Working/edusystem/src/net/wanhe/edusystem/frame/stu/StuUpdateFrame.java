package net.wanhe.edusystem.frame.stu;
...
public class StuUpdateFrame extends JFrame {
...
//    }
     ...
     * 该构造方法指定了当前窗口对象的信息
     */
    public StuUpdateFrame(Student stu) {
        //设置当前窗口的标题
        setTitle("学生管理-添加");
        //设置关闭该窗口时退出程序
        ...
        btnNewButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Student stu = new Student(Integer.parseInt(num),name,Integer.parseInt(age),phone,address);
    ...
    初始化窗口中的信息
     */
    public void initFrame(Student stu){
        textField.setText(stu.getNum()+ "");
        textField.disable();//禁止修改  只读
        textField_1.setText(stu.getName()+ "");
        textField_2.setText(stu.getAge()+ "");
        textField_3.setText(stu.getPhone()+ "");
        textField_4.setText(stu.getAddress()+ "");
    }
