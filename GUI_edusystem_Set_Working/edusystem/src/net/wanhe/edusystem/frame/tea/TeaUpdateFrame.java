...
public class TeaUpdateFrame extends JFrame {
...
//    }
     ...
     * 该构造方法指定了当前窗口对象的信息
     */
    public TeaUpdateFrame(Teacher tea) {
        //设置当前窗口的标题
        setTitle("学生管理-添加");
        //设置关闭该窗口时退出程序
    ...
    初始化窗口中的信息
     */
    public void initFrame(Teacher tea){
        textField.setText(tea.getNum()+ "");
        textField.disable();//禁止修改  只读
        textField_1.setText(tea.getName()+ "");
        textField_2.setText(tea.getAge()+ "");
        textField_3.setText(tea.getPhone()+ "");
        textField_4.setText(tea.getAddress()+ "");
    }
